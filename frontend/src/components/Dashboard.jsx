          ...
          <div class="invoice-card" id="invoice-card">
            ...
            <div class="details-grid">
              ...
              <div class="details-block">
                ...
                <div class="details-row">
                  <strong>Order ID:</strong> <span style="font-family: monospace;">${order.id ? 'ON' + String(order.id).padStart(6, '0') : 'Pending'}</span><br>
                ...
                <div className="card p-4 flex items-center justify-between">
                  ...
                  <div className="flex gap-2">
                    {selectedOrder.order.status === 'Undelivered' && (
                      <button
                        disabled={isReadying || isCompleting}
                        onClick={() => handleReady(selectedOrder.order.bill_number)}
                        className="btn-primary bg-amber-500 hover:bg-amber-600 text-white"
                      >
                        <Clock className="w-4 h-4" />
                        {isReadying ? 'Saving…' : 'Order Ready'}
                      </button>
                    )}
                    {(selectedOrder.order.status === 'Undelivered' || selectedOrder.order.status === 'Ready') && (
                      <button
                        disabled={isReadying || isCompleting}
